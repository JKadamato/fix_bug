...
import DiscountIcon from "@app/resources/images/discount_icon.svg";
import SelectedDiscountIcon from "@app/resources/images/selected_discount_icon.svg";

import TagIcon from "@app/resources/images/tag_icon.svg";
import SelectedTagIcon from "@app/resources/images/selected_tag_icon.svg";

import BestConnectionIcon from "@app/resources/images/best_connection_icon.svg";
              ...
              <ul className="flex items-center flex-1 list-menu">
                <li>
                  <NavLink exact to="/" className="uppercase">
                    <img
                      src={
                        this.isSelected("/") && location.pathname.length === 1
                          ? SelectedHomeIcon
                          : HomeIcon
                      }
                      style={{ width: 24, height: 24, color: "#9e9e9e" }}
                    />
                ...
                <li>
                  <NavLink exact to="/users" className="uppercase">
                    <img
                      src={
                        this.isSelected("/users") ? SelectedUserIcon : UserIcon
                      }
                      style={{ width: 24, height: 24, color: "#9e9e9e" }}
                    />
                ...
                <li>
                  <NavLink exact to="/discount" className="uppercase">
                    <img
                      src={
                        this.isSelected("/discount")
                          ? SelectedDiscountIcon
                          : DiscountIcon
                      }
                      style={{ width: 24, height: 24, color: "#9e9e9e" }}
                    />
                    <div style={{ marginTop: 3 }}>Discount</div>
                  </NavLink>
                </li>
                ...
                <li>
                  <NavLink exact to="/ads" className="uppercase">
                    <img
                      src={this.isSelected("/ads") ? SelectedAdsIcon : AdsIcon}
                      style={{ width: 24, height: 24, color: "#9e9e9e" }}
                    />
                ...
                <li>
                  <NavLink exact to="/tag" className="uppercase">
                    <img
                      src={this.isSelected("/tag") ? SelectedTagIcon : TagIcon}
                      style={{ width: 24, height: 24, color: "#9e9e9e" }}
                    />
                ...
                <li>
                  <NavLink exact to="/best-connection" className="uppercase">
                    <img
                      src={
                        this.isSelected("/best-connection")
                          ? BestConnectionIcon
                          : BestConnectionIcon
                      }
                      style={{ width: 24, height: 24, color: "#9e9e9e" }}
                    />
                    <div style={{ marginTop: 3 }}>Best Connection</div>
                  </NavLink>
                </li>
              </ul>
              <Action
