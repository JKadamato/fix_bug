      ...
      <div className="custom-tooltip">
        {payload?.map((item, index) => (
          <div className="mb-2" key={index}>
            <div className="custom-tooltip__title uppercase">
              {item?.dataKey}
            </div>
            <div className="custom-tooltip__content uppercase">
              {item?.value}
            </div>
          </div>
        ))}
...
const COLORS2 = ["#89d34f", "#2F6FA7", COLORS.third];
        ...
        return (
          ...
          >
            <div className="flex items-center">
              ...
              ></div>
              <div className="ml-3">{entry?.value?.split(" ")?.[0] || ""}</div>
            </div>
          </li>
        );
      })}
      ...
      <div className="flex">
        <div className="core-card flex-1 mr-4 h-24">
          ...
          <div className="title-2 uppercase text-black mt-2">
            {dashboardOverview?.amountTodayUser}
          </div>
        </div>
        <div className="core-card flex-1 mr-4 h-24">
          <div className="pa-10 uppercase second-text-color">
        ...
        <div className="core-card flex-1 mr-4 h-24">
          ...
          <div className="title-2 uppercase text-black mt-2">
            {dashboardOverview?.amountServer}
          </div>
        </div>
                ...
                <ResponsiveContainer>
                  <PieChart>
                    <Pie
                      ...
                      dataKey="value"
                    >
                      {(pieChart?.chart || []).map((entry, index) => (
                        <Cell
                          key={`cell-${index}`}
                ...
                <ul>
                  <li className="mb-4 pa-13 font-medium flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <div>
                        {pieChart?.overview?.free?.total || 0} (
                        {pieChart?.overview?.free?.percent || 0}%)
                      </div>
                    </div>
                  </li>
                  <li className="mb-4 pa-13 font-medium flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <div>
                        {pieChart?.overview?.monthly?.total || 0} (
                        {pieChart?.overview?.monthly?.percent || 0}%)
                      </div>
                    </div>
                  </li>
                  <li className="mb-4 pa-13 font-medium flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <div>
                        {pieChart?.overview?.weekly?.total || 0} (
                        {pieChart?.overview?.weekly?.percent || 0}%)
                      </div>
                    </div>
                  </li>
                </ul>
          ...
          <div style={{ width: "100%", height: 300 }} className="flex-1">
            <ResponsiveContainer>
              ...
              >
                ...
                <Area
                  stackId="name"
                  dot={{ stroke: "#2F6FA7", strokeWidth: 4 }}
                  type="linear"
                  dataKey="value"
                  stroke="#2F6FA7"
